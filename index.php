...
<style>
    .bg-div {
        background: linear-gradient(rgba(0, 0, 0, 0.5),
                rgba(0, 0, 0, 0.5)), url("./img/slider/open.png");
        /* Full height */
        height: 680px;
...
<title>Home</title>
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2645491693843624"
        ...
        <div class="jumbotron text-center p-0 mb-0">
            <div class="bg-div px-5 d-flex align-items-center">
                ...
                <div class="text-left w-50">
                    <h1 class="display-4 text-white">Welcome to letusblog.site!</h1>
		    <h2 class="display-5 text-white">Get Latest follow up articles for free!</h2>
                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="post post-row">
                                        ...
                                        <div class="post-body">
                                            ...
                                            <h3 class="post-title"><a href="single_article.php?id=<?= $article['article_id'] ?>"><?= $article['article_title'] ?></a></h3>
					    <p><a href="single_article.php?id=<?= $article['article_content'] ?>"><?= $article['article_content']?></a></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- /post -->
