                ...
                <div class="content bg-white col-lg-9 p-0 border border-muted">
                    ...
                    <div class="post__content w-75 mx-auto">
                        ...
                        <div class="post-footer d-flex my-5">
                            ...
                            <img class="profile-thumbnail rounded-circle pr-2" src="img/avatar/shadab" alt="test avatar image" style="width: 120px;height: 120px;">
                ...
                <div class="aside col-3">
                    ...
                    <div class="p-3 bg-white border  border-muted">
                        <div class="d-flex align-items-center">
                            <img class="profile-thumbnail rounded-circle" src="img/avatar/author_avatar" alt="test avatar image" style="width: 60px;height: 60px;">
                    ...
                    <!-- <div class="p-3 bg-white border  border-muted">
                            ...
                            <div class="d-flex align-items-center">
                                <img class="profile-thumbnail rounded-circle" src="img/avatar/shadab" alt="test avatar image" style="width: 60px;height: 60px;">
